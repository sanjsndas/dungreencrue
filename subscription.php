...
<head>
    ...
    <title>Dungreencrue - You are subscribed to the newsletter!</title>
    
    <meta property="og:title" content="Dungreencrue - You are subscribed to the newsletter!" />
    <meta property="og:image" content="logo2.svg"/>
    <meta property="og:description" content="Dungreencrue - You are subscribed to the newsletter!">
    <meta name="description" content="Dungreencrue - You are subscribed to the newsletter!">
...
<style>
	* {
	...
	.bodyClass1-container-sectiontu{
		background: #f8fff7;
		color: #ffffff;
	}
	.bodyClass2-container-sectiontu{
		background: #fff;
		color: #fff;
	}
	.bodyClass3-container-sectiontu{
		background: #fff;
		color: #111;
	}
	.wrapage-block-container-sectiontu{
		background-size: 100%;
		width: 100%;
	}
	.box_main-container-sectiontu{
		width: 100%;
		margin: 0 auto;
		text-align: center;
		display: flex;
	...
	.box_main-container-sectiontu h2{
		font-size: 24px;
		padding: 0px 0px 25px;
	}
	.box_main-container-sectiontu p{
		font-weight: 500;
		font-size: 18px;
	}
	p{
	...
	.mainBlock-container-sectiontu{
		text-align: center;
	}
	.mainBlock-container-sectiontu ul{
		text-align: start;
		padding: 20px;
		display: flex;
		flex-direction: column;
	...
	.mainBlock-container-sectiontu ul>li span{
		font-weight: bold;
	}
	.mainBlock-container-sectiontu{
		max-width: 1097px;
	...
	.mainBlock-container-sectiontu .cBlock-container-sectiontu{
		text-align: center;
	}

	.bodyClass3-container-sectiontu .mainBlock-container-sectiontu{
		background: none;
		border-top: 2px dashed #e8ffff;
		border-bottom: 2px dashed #e8ffff;
	}
	.bodyClass2-container-sectiontu .mainBlock-container-sectiontu{
		background: #060930;
		color: #fff !important;
		box-shadow: 0px 0px 15px #060930;
	}
	.bodyClass2-container-sectiontu .mainBlock-container-sectiontu p{
		color: #fff !important;
	}
	.bodyClass1-container-sectiontu .mainBlock-container-sectiontu{
		background: #03408C;
		color: #ffffff;
		border-left: 4px solid #00ADB5;
	}
	.bodyClass1-container-sectiontu .mainBlock-container-sectiontu p{
		color: #ffffff !important;
	}
	.order-container-sectiontu{
...
<div class="bodyClass2-container-sectiontu" id="mainWrapp-container-sectiontu">


	<div class="wrapage-block-container-sectiontu">
		<div class="box_main-container-sectiontu">
			<div class="mainBlock-container-sectiontu">
...
<p class="cBlock-container-sectiontu">With our warmest regards!</p>
			</div>
		</div>
	</div>
